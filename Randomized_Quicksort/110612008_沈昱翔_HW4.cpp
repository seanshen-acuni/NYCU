...
int RM_partition(vector<int>& A, int p, int r) {
    srand(time(0));
    int i = p + rand() % (r - p); // Generate a random index
    swap(A[i], A[r]); // Swap the random element with the last element
    return partition(A, p, r); // Perform Lomuto Partitioning
}
...
int main() {
    ...
    */
    ...
    /*
            ...
            cout << endl;
    */
    cout << "insertion-sorting runtime:" << (END1 - START1) << endl;
    ...
    /*
         ...
         cout << endl;
    */
    cout << "merge-sorting runtime:" << (END2 - START2) << endl;
    ...
    /*
        ...
        cout << endl;
    */
    cout << "heapsorting runtime:" << (END3 - START3) << endl;

    //ramdomized quicksort
    START4 = clock();
    RM_quickSort(arrayd, 0, size - 1);
    END4 = clock();
    /*      
        cout << "Generated array(by randomized quicksort):" << endl;
        for (int i = 0; i < size; i++) {
            cout << arrayd[i] << " ";
    }   
        cout << endl;
    */
    cout << "randomized quicksort runtime:" << (END4 - START4) << endl;
